...
// Man kann die Berechnung auch in einer Funktion abgebildet werden.
...
console.log('Das Volumen bertägt 1000 oder mehr Quadratzentimeter.');
...
let mwstBetrag = rechnung.mwst();
console.log(`Die MwSt beträgt: ${mwstBetrag.toFixed(2)} EUR`);
